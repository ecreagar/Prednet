...
#categories = ['city'] #added temporarily to allow GPU machines to process the data set 10.15.19
...
def download_data():
    ...
    for c in categories:
        ...
        # drive_list = drive_list[0:17]  # Temporary Add to allow GPU machines to process the entire data set- 10.15.19
...
def process_im(im, desired_sz):
    ...
    #undeprication
    #im = numpy.array(im.fromarray(desired_sz).resize())
